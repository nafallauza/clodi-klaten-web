...
<head>
    ...
    <title>Kelola Produk | Clodi Klaten Babyshop</title>
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <div>
                ...
                <p class="text-slate-500 mt-2">
                    ...
                    Daftar seluruh produk yang ditampilkan
                    pada Landing Page.
...
<div class="mt-4 p-4 rounded-lg bg-red-100 text-red-700">
...
<a
    ...
    class="bg-sky-600 hover:bg-sky-700 text-white px-6 py-3 rounded-xl font-semibold inline-block">
    ...
    Rp <?= number_format($row['price'],0,",","."); ?>
                        ...
                        <td>
                            ...
                            if($row['original_price']!=NULL){
                                ...
                                echo "Rp ".number_format($row['original_price'],0,",",".");
